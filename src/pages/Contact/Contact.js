...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-100 pt-10 pb-20">
        ...
        {successMsg ? (
          ...
          <form>
            ...
            <div className="w-[500px] h-auto py-6 flex flex-col gap-6">
              ...
              <button
                onClick={handlePost}
                className="w-100 bg-primeColor text-gray-200 h-10 font-titleFont text-base tracking-wide font-semibold hover:bg-black hover:text-white duration-200"
              >
                Post
              </button>
            </div>
